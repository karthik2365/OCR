...
// Define the OverpassElement type here to replace 'any' in the fetching logic
...
    fetchRoute()
  }, [originCoordinates, destinationCoordinates, loading])
  
  // Custom Polyline decoding function for OSRM
  const decodePolyline = (str: string, precision: number): [number, number][] => {
    // FIX START: Separating declarations to fix "Expected ident" syntax error
